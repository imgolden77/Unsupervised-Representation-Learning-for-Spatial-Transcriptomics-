...
# truth = query_data.obsm['truth']
# print("Truth shape:", truth.shape)
# print("Truth min:", np.min(truth))
# print("Truth max:", np.max(truth))
# print("Zero ratio:", np.sum(truth == 0) / truth.size)
# print("Any nonzero:", np.any(truth != 0))
