...
#SBATCH --mem=32G                         # 메모리
#SBATCH --output=logs/cell_annotation/annotation_emb_%j_20250730GSE151530_Liver.out            # 표준 출력 로그 (%j = job ID)
#SBATCH --error=logs/cell_annotation/annotation_emb_%j_20250730GSE151530_Liver.err             # 표준 에러 로그
