...
#SBATCH --mem=32G                         # 메모리
#SBATCH --output=logs/cell_embedding/fit/embedding_%j_20250730gse155468_fit_supcon.out            # 표준 출력 로그 (%j = job ID)
#SBATCH --error=logs/cell_embedding/fit/embedding_%j_20250730gse155468_fit_supcon.err             # 표준 에러 로그
