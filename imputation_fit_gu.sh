...
#SBATCH --mem=32G                         # 메모리
#SBATCH --output=imputation_gu_%j_20250717DLPFC_debug.out            # 표준 출력 로그 (%j = job ID)
#SBATCH --error=imputation_gu_%j_20250717DLPFC_debug.err             # 표준 에러 로그
...
# ✅ Python 코드 실행
python imputation_fit_gene_update.py
