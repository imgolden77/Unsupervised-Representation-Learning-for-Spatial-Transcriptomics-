...
#SBATCH --mem=128G                         # 메모리
#SBATCH --output=logs/cell_embedding/fit/supCon/embedding_%j_0823DLPFC_I.out            # 표준 출력 로그 (%j = job ID)
#SBATCH --error=logs/cell_embedding/fit/supCon/embedding_%j_0823DLPFC_I.err             # 표준 에러 로그

#DLPFC #MERFISH #LungCancer #Aorta #colon #lung #liver
# ✅ 모듈 로드
