...
DEVICE = 'cuda:0'
DATA = 'DLPFC' #'lung_ensg' #'colon' #'breast' #'gse155468' #'GSE151530_Liver_ensg' # 'GSE131907_Lung_ensg'
...
sc.pl.umap(data, color='layer', palette='Paired', title=f"{DATA}\nARI={ari:.3f}, NMI={nmi:.3f}", size=50)
plt.savefig(f"./figure/{DATA}_embedding_zero.png", dpi=300)
plt.show()