...
#SBATCH --mem=32G                         # 메모리
#SBATCH --output=logs/imputation/imputation_fit1_%j_20250803DLPFC_ref_sc_ensg_ep100.out            # 표준 출력 로그 (%j = job ID)
#SBATCH --error=logs/imputation/imputation_fit1_%j_20250803DLPFC_ref_sc_ensg_ep100.err             # 표준 에러 로그
